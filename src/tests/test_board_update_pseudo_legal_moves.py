...
class BoardUpdatePseudoLegalMovesTest(unittest.TestCase):
    def get_piece(_, pos):
    ...
    def setUp(self):
        ...
        r1.get_pseudo_legal_moves = MagicMock(return_value = {(7, 1), 
                                                              (7, 2), 
                                                              (7, 3), 
                                                              (7, 4), 
                                                              (7, 5), 
        ...
        r2.get_pseudo_legal_moves = MagicMock(return_value = {(7, 1), 
                                                              (7, 2), 
                                                              (7, 3), 
                                                              (7, 4), 
                                                              (7, 5), 
    ...
    def test_board(self):
        ...
        self.assertSetEqual(self.gb.attackable_tiles_from[PieceColor.BLACK], {(6, 7), 
                                                                              (5, 7), 
                                                                              (4, 7), 
                                                                              (3, 7), 
                                                                              (2, 7), 
